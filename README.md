...
| Min 7 | Change 3 (Add weather forecast): Open index.html, insert HKO public API code between &lt;body&gt; tags, save and exit. | 1. `cd /var/www/album1`<br/>2. `rm -r index.html`<br/>3. `nano index.html`<br/>4. `Replace the whole code from GitHub`<br/>5. `Press Control+X, Y, Enter` |
