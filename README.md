...
| Min 8 | Change 4 (Add live chat): Open index.html, insert Firebase chat code, save and exit. | 1. `cd /var/www/album1`<br/>2. `nano index.html`<br/>3. [Insert the code after `<!-- MUSIC PART END -->` from GitHub ↓](#min-8-replace-photos--add-music)<br/>4. `Press Control+X, Y, Enter` |
