...
| Min 7 | Change 3 (Add weather forecast): Open index.html, insert HKO public API code between <body> tags, save and exit. | `1. cd /var/www/album1`<br/>`2. nano index.html`<br/>`3. Insert the code between <body> and </body>`<br/>`"<!-- HKO 9-Day Weather Forecast Widget -->
...
<script>
  ...
  function simplifyWind(windText) {
    ...
    /*
      This part keeps the wind label short,
      so the words will not crash inside the column.
    */
...
</script>"`<br/>`4. Press Control+X, Y, Enter` |
